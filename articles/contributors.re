...
#@# アウトプットをすることで自分の未来も変えられる / kotoe.ishige
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
...
#@# アウトプットを誰かのためではなく、自分のためだけにしてみた / なおと
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
...
#@# アウトプットの始め方： 40代独立系SIerのケース / MzRyuka
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
...
#@# 50歳を目前にアウトプットをしようと決意したこと / sapi_kawahara
//embed{
   \begin{minipage}{.1\linewidth}
       \centering
...
#@# 「分からない」が教えてくれたこと / taktstock (Task4ce_Hisui)
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
...
今回、個人サークルはお休みでしたが、技術書典7では個人サークルで出したいですね。

　

#@# 人財エージェント目線でのアウトプットの重要性について / takano
//embed{
    \begin{minipage}{.1\linewidth}
        \centering
...
//embed{
    ...
    \hspace{1ex}
//}
役者をしていたり楽器を弾いていたりエンジニアをしていたり校正さんをしていたり。
ふわりふわりと生きています。またいつか、どこかで。
