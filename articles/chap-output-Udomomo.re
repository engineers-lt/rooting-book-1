...
ならばどうしてアウトプットしているのかといえば、「それが結果的により良いインプットにつながる」と考えているからです。そして、ここでいうアウトプットとは、ブログやLTだけではなく、もっと手軽で簡単なものも含んでいます。このコラムでは、アウトプットに自信がない人が、より多くのインプットを得るためにどうやって外に出ていけばいいか、その最初の一歩について紹介します。
...
という考えに達しました。いうなればインプットのためにアウトプットをすることになったわけです。
...
個人的におすすめのSlackコミュニティは、この本の執筆母体でもある「エンジニアの登壇を応援する会」です。その名の通り、登壇を含めたアウトプットをしたい人たちが集まっています。技術相談から飯テロ画像まで何でも気軽に投稿できますので、興味のある方はGoogle検索して公式サイトから加入してください。 
...
質問サイトはいくつかありますが、個人的にはteratailをおすすめします。単に回答者が多いだけでなく、「正確な質問をする」ことが非常に重視されているためです。質問に雑なところがあると、何の情報を追加すべきか指摘が来るので、技術についてのアウトプットをするうえでとても良い練習になります。   
...
このようなことを習慣づけると、入ってくる情報がだいぶ変わってきます。知らないサイトの良い記事がSlackでシェアされたり、懇親会で出会った人が新しいフレームワークについて熱く語ってきたり、Twitterでよくわからないテーマについてエンジニア同士が議論しているのを目にしたりするようになると思います。インプット好きなあなたなら「なんだそれは...？」と思って調べ出すでしょう。そうしてあなたの知識は、未知の領域へと広がっていくのです。
...
そこで、自分の知っている知見をもとにブログ記事を書き、それをシェアするようにしてみたところ、不正確な内容に対して指摘が入ったり、同じところを勉強した経験のある方から補足を教えていただいたりすることが増えました。特に、Java8のラムダ式についてまとめた記事をシェアしたときは、詳しい方からおすすめの本として「Effective Java」と「Java SE 8 実践プログラミング」を紹介していただきました。Javaの本は数がとても多く、どれが今の自分に合っている本か一人ではわからなかったため、とても助かりました。@<br>{}
